...
struct view3DRoomTemp: View {
    ...
    init() {
        ...
        //                RoomModel = BuildMyRoom2(room: room)
        //            }
        //        }
        ...
        self._RoomModel = ObservedObject(wrappedValue: BuildMyRoom2(room: room,dominantRoomColors: uIDominantRoomColors))
        ...
        ZStack(alignment: .leading) {
            ...
            VStack (alignment: .leading){
                ...
                HStack{
                    ...
                    Spacer()
                    Button(action: {
//                        let wholeScene = BuildMyRoom2(room: RoomModel.room, dominantRoomColors: RoomModel.dominantRoomColors)
